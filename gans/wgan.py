...
class WGAN:
    ...
    def build_combined(self):
        ...
        return models.Model(noise, validity, name="WGAN")
    ...
    def save_models(self, path="saved_models"):
        ...
        self.discriminator.save(f"{path}/wgan_discriminator.h5")
    ...
    def load_models(self, path="saved_models"):
        ...
        self.discriminator = models.load_model(f"{path}/wgan_discriminator.h5")
